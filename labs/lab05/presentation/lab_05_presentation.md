...
- студент 3 курса кафедры ММИИИ  
- Российский университет дружбы народов им. П. Лумумбы  
- [1132236025@rudn.ru](mailto:1132236025@rudn.ru)  
- <https://gitverse.ru/NatLarina>  
- <https://github.com/NatLarina>
...
![Создание нового релиза](image/1.png)
...
![Запуск скрипта](image/8.png)

График результатов моделирования с арбитром:

![График arbiter_simulation](plots/arbiter_simulation.png)

## Jupyter Notebook

![Jupyter Notebook от скрипта](image/9.png)

## Запуск скрипта dining_philosophers_animation.jl

![Запуск скрипта анимации](image/10.png)

![Jupyter Notebook анимации](image/11.png)

![Результат анимации](image/12.png)

## Запуск скрипта dining_philosophers_report.jl

![Запуск скрипта отчёта](image/13.png)

![Jupyter Notebook отчёта](image/14.png)

График финального отчёта:

![График final_report](plots/final_report.png)
...
![Создание форматов](image/16.png)

![Создание форматов](image/17.png)

![Создание форматов](image/18.png)

## Проверка результатов

Проверка созданных файлов в папке plots:

![Проверка plots](image/19.png)
