...
![Запуск скрипта scripts/dining_philosophers.jl](image/8.png)

![График скрипта scripts/dining_philosophers.jl](plots/arbiter_simulation.png)

![jupyter-notebook от scripts/dining_philosophers.jl](image/9.png)

Создание, запуск следующего скрипта scripts/dining_philosophers_animation.jl и создание его производных форматов

![Запуск скрипта scripts/dining_philosophers_animation.jl](image/10.png)

![График скрипта scripts/dining_philosophers_animation.jl](image/12.png)

![jupyter-notebook от scripts/dining_philosophers_animation.jl](image/11.png)

Далее снова перехожу в директорию проекта и создаю и запускаю следующий скрипт scripts/dining_philosophers_report.jl

![Запуск скрипта scripts/dining_philosophers_report.jl](image/13.png)

![График скрипта scripts/dining_philosophers_report.jl](plots/final_report.png)

![jupyter-notebook от scripts/dining_philosophers_report.jl](image/14.png)
...
![Создание производных форматов](image/16.png)

![Создание производных форматов](image/17.png)

![Создание производных форматов](image/18.png)
...
![Настройка _quarto.yml](image/21.png)

В файле отчёта подключаем файл описания программ

![Подключение файлов](image/20.png)

(В оригинале были некорректные включения, они заменены на обычный текст. Если требуется вставить содержимое других файлов, используйте синтаксис Quarto: `{{< include file.qmd >}}`.)
...
Имитационное моделирование. Практикум: [https://esystem.rudn.ru/pluginfile.php/3094278/modeling-lab.pdf](https://esystem.rudn.ru/pluginfile.php/3094278/modeling-lab.pdf)